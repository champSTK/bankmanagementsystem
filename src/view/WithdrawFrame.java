...
public class WithdrawFrame extends JFrame {
    ...
    public WithdrawFrame(DashboardFrame dashboardFrame, Account account) {
    ...
    private void initComponents() {
        ...
        confirmButton.addActionListener(e -> handleWithdraw());
    ...
    private void handleWithdraw() {
        ...
        try {
            ...
            boolean success = transactionController.withdraw(account.getAccountNumber(), amount);
